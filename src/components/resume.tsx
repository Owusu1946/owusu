...
export function Resume() {
  // Resume details
  const resumeDetails = {
    title: "Owusu Kenneth's CV",
    description: 'Full-Stack Engineer | AI and LLM Application Engineer',
    fileType: 'PDF',
      ...
      >
        ...
        <div className="p-5">
          <div className="flex items-center justify-between">
            ...
            {/* Download indicator */}
            <motion.div
              className="flex h-10 w-10 items-center justify-center rounded-full bg-black text-primary-foreground group-hover:bg-black/80 dark:bg-white dark:text-black dark:group-hover:bg-white/80"
              initial={{ scale: 1 }}
            >
