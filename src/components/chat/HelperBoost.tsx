                ...
                >
                  {questionConfig.map(({ key, color, icon: Icon }) => (
                    <Button
                      ...
                      variant="outline"
                      className="h-auto min-w-[100px] flex-shrink-0 rounded-xl border border-border hover:bg-border/30 cursor-pointer bg-white/80 active:scale-95 px-4 py-3 shadow-none backdrop-blur-sm transition-none"
                    >
                  ...
                  <TooltipProvider>
                    <Tooltip delayDuration={0}>
                      <TooltipTrigger asChild>
                        ...
                        >
                          <motion.div
                            className="flex h-auto items-center space-x-1 rounded-xl border border-neutral-200 bg-white/80 hover:bg-border/30 cursor-pointer px-4 py-3 text-sm backdrop-blur-sm transition-all duration-200 dark:border-neutral-800 dark:bg-neutral-900"
                            whileHover={{ scale: 1 }}
                            whileTap={{ scale: 0.98 }}
                          >
                            <div className="flex items-center gap-3 text-gray-700">
